    ...
    <div class="main-banner">
      <div class="container">
        ...
        <div class="row pagination-centered">
          <div class="row">
            <button class="span4 offset4 btn btn-large btn-info">Guarda il video</button>
            <!--<button class="btn span3 btn-large">Crea un contest</button>-->
          </div>
        </div>
      </div>
          ...
          <g:each in="${Contest.findAll().sort {it.dateCreation}}" var="contest">
            ...
            <div class="span4 contest-box pagination-centered">
              ...
              <div class="contest-image">
                <img style="height:100%;"src="http://static.impossibleliving.com/media/Schermata_10-2456213_alle_16.25.17_crop_260x141.png"/>
              </div>
              <div>
              ...
              <ul class="action-list">
                ...
                <li></li>
                <li><h3 style="line-height:30px;margin-bottom:0px; padding-bottom: 0px;">${Math.round(contest.reward)}</h3>
                  euro</li>
              </ul>
